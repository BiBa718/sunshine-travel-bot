...
async def start(
    ...
    await message.answer(
        "👋 Здравствуйте! Добро пожаловать в SUNSHINE TRAVEL!\n\n"
        "Мы создаём индивидуальные туры по Китаю под ваш вкус и ритм.\n\n"
        "✅ Вы можете:\n"
        "• Взять готовый тур и изменить его (добавить/убрать города)\n"
        "• Изменить количество дней в любом городе\n"
        "• Создать полностью свой тур с нуля\n\n"
        "📱 Помощь с регистрацией WeChat и Alipay\n\n"
        "Напишите свой вопрос — и мы как можно скорее ответим на него!"
    )
